...
<?php ob_start(); ?>
			...
			<div class="corps" id="index">
				...
				<p>Soif de conaissances ou avide de nourritures spirituelles ? Les archivistes du Couloir mettent à votre disposition des ouvrages en tous genres dans leur antique <a href="biblio.php">biliothèque.</a></p>					
